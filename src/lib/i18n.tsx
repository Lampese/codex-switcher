...
const messages: Record<Language, Record<string, string>> = {
  en: {
    ...
    andReopenCodex: "and then reopen Codex",
    ...
    forceCloseSwitchAndReopen: "Force close, switch, and reopen Codex",
    ...
    switchedAndReopened: "Switched account and reopened Codex.",
    switchFailedAfterForce: "Switch failed after force close: {{message}}",
    switchSucceededOpenFailed: "Account switched, but Codex could not be reopened: {{message}}",
  ...
  zh: {
    ...
    switchedAndReopened: "账号已切换，Codex 已重新打开。",
    switchFailedAfterForce: "强制关闭后切换失败：{{message}}",
    switchSucceededOpenFailed: "账号已切换，但无法重新打开 Codex：{{message}}",
